==== Black Pro Search by Ssd Server 9 ====
...
Note : This plugin requires woocommerce to work
...
Hooks and filters from wordpress and woocommerce are used for the functionality of the plugin
